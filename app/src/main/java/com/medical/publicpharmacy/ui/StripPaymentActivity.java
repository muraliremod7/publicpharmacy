...
public class StripPaymentActivity extends AppCompatActivity {
    ...
    com.medical.publicpharmacy.model.PaymentItem paymentItem;
    double amount = 0.0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paymentItem = (com.medical.publicpharmacy.model.PaymentItem) getIntent().getSerializableExtra("detail");
